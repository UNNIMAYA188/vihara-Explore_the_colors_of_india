...
<body>
    ...
    <!-- Header Section -->
    <header>
        <h1>Delhi - Agra Tour Package</h1>
        <p>4 Days 3 Nights | Exploring monuments such as India Gate, Qutub Minar, Lotus Temple, Agra fort, and Red fort | Hot air balloon ride over Delhi's skyline | Adventurous boat ride along the Yamuna River </p>
    </header>
    ...
    <section id="overview">
        ...
        <p>A 4-day, 3-night Delhi-Agra tour package offers a perfect blend of history, culture, and architectural marvels. The journey begins in Delhi, where travelers explore India Gate. Enjoy an adventurous street food crawl through the narrow lanes of Old Delhi  tasting some of the best local dishes like chaat and kebabs. Explore the iconic Qutub Minar and Lotus Temple on a guided cycling tour, a thrilling way to experience the city. Hot air balloon rides over the Taj Mahal at sunrise offering panoramic views of the Taj Mahal, Yamuna River, Agra Fort, and the surrounding landscapes. Visit the historic Red Fort, and embark on an adventure hunt in the fort complex where you will solve clues to explore hidden gems. Head to an outdoor adventure park for some rock climbing challenges with stunning views of Delhi. In the evening, relax and watch the light and sound show at Akshardham, learning about India's rich history. Enjoy a comfortable drive to Agra and check in at hotel. Start your day early with a stunning sunrise visit to the Taj Mahal. After visiting the Taj Mahal, embark on an adventure walk through the historic Agra Fort exploring its secret passageways and learning about its rich history. Explore the outskirts of Agra with an off-road biking tour through rural landscapes and lesser-known sites. Take an adventurous boat ride along the Yamuna River, visiting Mehtab Bagh. Head to Fatehpur Sikri for a historical exploration tour involving some fun facts and adventurous moments. Drive back to Delhi for your departure or onward journey with your heart racing from all the thrilling activities!</p>
        <img src="taj.jpeg" alt="taj" width="1425px" height="700px"  >
    </section>
    <section id="speciality">
<h2>What’s Special About Delhi - Agra Tour Packages!</h2>
<p>A Delhi-Agra tour package blends history, culture, and adventure for an unforgettable experience. In Delhi, explore India Gate, Qutub Minar, and Lotus Temple on a guided cycling tour, followed by a thrilling street food crawl in Old Delhi. Visit the Red Fort for an interactive adventure hunt, try rock climbing at an outdoor park, and end the evening with a mesmerizing light and sound show at Akshardham. Travel to Agra for a breathtaking hot air balloon ride over the Taj Mahal at sunrise, followed by an adventure walk through Agra Fort’s hidden passageways. Experience an off-road biking tour through rural Agra, a boat ride on the Yamuna River near Mehtab Bagh, and a fun-filled historical exploration of Fatehpur Sikri. Conclude your journey with a drive back to Delhi, leaving with memories of both heritage and adventure!</p>
...
<section>
    ...
    <a href="package_booking.php" class="btn btn-secondary disabled" tabindex="-1" role="button" aria-disabled="true">Link</a>
