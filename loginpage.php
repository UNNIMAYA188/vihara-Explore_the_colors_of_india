      ...
      <div class="container-fluid">
        ...
        <div style="padding-left: 55%;" class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a style="color: black;" class="nav-link" href="signup.php" >Packages</a>
            </li>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a style="color: black;" class="nav-link" href="admin_login.php" >admin login</a>
            </li>
  ...
  <tbody id="packageTable">
    ...
    while ($row = $result->fetch_assoc()) {
      ...
      <tr data-destination="<?php echo $row['name']; ?>" data-budget="<?php echo $row['price']; ?>" data-duration="<?php echo $row['duration']; ?>">
        ...
        <td><a href="signup.php" class="btn btn-primary">View Package</a></td>
      </tr>
      <?php
    }
    ?>
